...
func easyjsonF041b085DecodeGithubComDeadlineTeamDtalksBotApiModel(in *jlexer.Lexer, out *TokenInfo) {
...
func easyjsonF041b085EncodeGithubComDeadlineTeamDtalksBotApiModel(out *jwriter.Writer, in TokenInfo) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UserId != "" {
...
func (v TokenInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF041b085EncodeGithubComDeadlineTeamDtalksBotApiModel(&w, v)
...
func (v *TokenInfo) UnmarshalJSON(data []byte) error {
	...
	easyjsonF041b085DecodeGithubComDeadlineTeamDtalksBotApiModel(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *TokenInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF041b085DecodeGithubComDeadlineTeamDtalksBotApiModel(l, v)
}
